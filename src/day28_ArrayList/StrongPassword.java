...
public class StrongPassword {
    ...
    public static void main(String[] args) {
        ...
        //these are temporary values that we will reassign if the password meets the criteria
        boolean r2 = false; // has upper case
        boolean r3 = false; //has lower case
        boolean r4 = false; //has special char
        boolean r5 = false; // has digit

        char[] chars = password.toCharArray(); //Now we can see each character of the String

        for (char each : chars) { //this checks each of the characters one by one
          ...
          boolean isStrongPassword = r1 && r2 && r3 && r4 && r5; // all the requirements must be true
