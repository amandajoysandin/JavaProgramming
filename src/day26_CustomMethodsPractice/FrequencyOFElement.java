...
public class FrequencyOFElement {
    ...
    public static void main(String[] args) {
        int[] arr = {1,1,1,1,1,2,2,3,3,3,4,4,4,1,1,1,1};
...
//returns the frequency of the given element from the given array
    ...
    public static int frequencyOfElement(int [] array, int element){
        int count = 0;  //we are starting the count at 0
        for(int each : array){
            if(each == element){
                count++;
            }
    ...
    //returns frequency of element from array
...
//returns frequency of element from the given array
